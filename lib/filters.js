...
exports.addslashes = function (input) {
  const out = iterateFilter.apply(exports.addslashes, arguments);
  if (out !== undefined) {
    return out;
  }
...
exports.capitalize = function (input) {
  const out = iterateFilter.apply(exports.capitalize, arguments);
  if (out !== undefined) {
    return out;
  }
...
exports.date = function (input, format, offset, abbr) {
  ...
  const date = new dateFormatter.DateZ(input);
  let cur;
  let i = 0;
  let out = '';
...
exports.escape = function (input, type) {
  let out = iterateFilter.apply(exports.escape, arguments);
  let inp = input;
  let i = 0;
  let code;
...
exports.groupBy = function (input, key) {
  ...
  utils.each(input, function (value) {
    ...
    const newValue = utils.extend({}, value);
    delete newValue[key];
...
exports.lower = function (input) {
  const out = iterateFilter.apply(exports.lower, arguments);
  if (out !== undefined) {
    return out;
  }
...
exports.striptags = function (input) {
  const out = iterateFilter.apply(exports.striptags, arguments);
  if (out !== undefined) {
    return out;
  }
...
exports.title = function (input) {
  const out = iterateFilter.apply(exports.title, arguments);
  if (out !== undefined) {
    return out;
  }
...
exports.upper = function (input) {
  const out = iterateFilter.apply(exports.upper, arguments);
  if (out !== undefined) {
    return out;
  }
...
exports.url_encode = function (input) {
  const out = iterateFilter.apply(exports.url_encode, arguments);
  if (out !== undefined) {
    return out;
  }
...
exports.url_decode = function (input) {
  const out = iterateFilter.apply(exports.url_decode, arguments);
  if (out !== undefined) {
    return out;
  }
