...
const cases = {
  ...
  escape: [
    ...
    {
      c: 'v|e("js")',
      v: '"double quotes" and \'single quotes\'',
      e: '\\u0022double quotes\\u0022 and \\u0027single quotes\\u0027'
    },
    {
      c: 'v|escape("js")',
      v: '<script>and this</script>',
      e: '\\u003Cscript\\u003Eand this\\u003C/script\\u003E'
    },
    {
      c: 'v|e("js")',
      v: '\\ : backslashes, too',
    ...
    {
      c: 'v|e("js")',
      v: 'and lots of whitespace: \r\n\t\v\f\b',
      e: 'and lots of whitespace: \\u000D\\u000A\\u0009\\u000B\\u000C\\u0008'
    },
    {
      c: 'v|e("js")',
      v: 'and "special" chars = -1;',
      e: 'and \\u0022special\\u0022 chars \\u003D \\u002D1\\u003B'
    },
    { c: 'v|e', v: ['<p>', '</p>'], e: '&lt;p&gt;,&lt;/p&gt;' }
  ],
  first: [
  ...
  groupBy: [
    {
      c: 'v|groupBy("name")|json',
      v: [{ name: 'a', a: 1 }, { name: 'a', a: 2 }, { name: 'b', a: 3 }],
      e: JSON.stringify({ a: [{ a: 1 }, { a: 2 }], b: [{ a: 3 }] }).replace(
        /"/g,
        '&quot;'
      )
    },
  ...
  uniq: [{ v: [2, 1, 2, 3, 4, 4], e: '2,1,3,4' }, { v: 'foo', e: '' }],
  upper: [
    { v: 'bar', e: 'BAR' },
    { v: 345, e: '345' },
    { v: ['foo', 'bAr'], e: 'FOO,BAR' },
