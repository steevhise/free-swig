...
const cases = {
  ...
  'return empty string if undefined': [{ c: '"{{ u }}"', e: '""' }],
  ...
  'can include arrays': [{ c: '{{ [0, 1, 3] }}', e: '0,1,3' }],
  'are escaped by default': [{ c: '{{ foo }}', e: '&lt;blah&gt;' }],
  ...
  'can run multiple filters': [{ c: '{{ a|default("")|default(1) }}', e: '1' }],
